...
<LocationCard>:
    ...
    MapView:
        ...
        min_zoom: 8   # Regional view (can see major cities and regions)
        max_zoom: 18  # Detailed view (can see buildings clearly)
        size_hint_y: None
        height: dp(230)
...
class ModernSocialApp(MDApp):  # Changed from ProfileApp to ModernSocialApp
    def build(self):
